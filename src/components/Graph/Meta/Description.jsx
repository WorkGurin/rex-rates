...
class Description extends Meta {
    ...
    render() {
        ...
        return (
            <p className="lead">{yearFragment.length ? yearFragment : 'Since 2010'}, {USStateFragment} {yearFragment.length ? 'created' : 'created'} {N}
                jobs for React developers{previousYearFragment}, who earned between ${min_salary} and ${max_salary}.</p>
        );
    }
}
